...
this.launch = function () {
    ...
    M.init = function (div) {
        ...
        M.goodTooltip = function (id) {
            return function () {
                ...
                let str =
                    ...
                    '">' +
                    (delta + '' + (delta == Math.floor(delta) ? '.00' : delta * 10 == Math.floor(delta * 10) ? '0' : '') + '%') +
                    '</span></span></div>' +
        ...
        str +=
            ...
            Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.officeTooltip()', 'this') +
            ...
            Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.brokersTooltip()', 'this') +
            ...
            Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.loanTooltip(1)', 'this') +
            '>1st loan</div><div id="bankLoan2" style="display:none;" class="bankButton bankButtonSell bankButtonOff" ' +
            Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.loanTooltip(2)', 'this') +
            '>2nd loan</div><div id="bankLoan3" style="display:none;" class="bankButton bankButtonSell bankButtonOff" ' +
            Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.loanTooltip(3)', 'this') +
            '>3rd loan</div></div>' +
        ...
        for (let i = 0; i < M.goodsById.length; i++) {
            ...
            str +=
                ...
                '">' +
                '<div ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.goodTooltip(' + me.id + ')', 'this') +
                '>' +
                ...
                me.id +
                '_1" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.tradeTooltip(' + me.id + ',1)', 'this') +
                '>1</div>' +
                '<div class="bankButton bankButtonBuy" id="bankGood-' +
                me.id +
                '_10" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.tradeTooltip(' + me.id + ',10)', 'this') +
                '>10</div>' +
                '<div class="bankButton bankButtonBuy" id="bankGood-' +
                me.id +
                '_100" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.tradeTooltip(' + me.id + ',100)', 'this') +
                '>100</div>' +
                '<div style="width:28px;" class="bankButton bankButtonBuy" id="bankGood-' +
                me.id +
                '_Max" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.tradeTooltip(' + me.id + ',10000)', 'this') +
                '>Max</div>' +
                '<br>' +
        ...
        M.graph.addEventListener('mousemove', function (e) {
            ...
            bankGraphMouseDetect: for (let i = M.goodsById.length - 1; i >= 0; i--) {
                let id = i;
                let me = M.goodsById[id];
