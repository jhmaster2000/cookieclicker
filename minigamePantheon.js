    ...
    M.init = function (div) {
        ...
        M.godTooltip = function (id) {
            return function () {
                ...
                let str =
                    ...
                    (me.desc1
                        ? '<div class="templeEffect templeEffect1"><div class="usesIcon shadowFilter templeGem templeGem1"></div>' + me.desc1 + '</div>'
                        : '') +
                    (me.desc2
                        ? '<div class="templeEffect templeEffect2"><div class="usesIcon shadowFilter templeGem templeGem2"></div>' + me.desc2 + '</div>'
                        : '') +
                    (me.desc3
                        ? '<div class="templeEffect templeEffect3"><div class="usesIcon shadowFilter templeGem templeGem3"></div>' + me.desc3 + '</div>'
                        : '') +
            ...
            return function () {
                ...
                let str =
                    ...
                    (M.slot[id] != -1
                        ...
                        '<div class="line"></div><div class="description"><div style="margin:6px 0px;font-weight:bold;">Effects :</div>' +
                        (me.activeDescFunc
                            ? '<div class="templeEffect templeEffectOn" style="padding:8px 4px;text-align:center;">' + me.activeDescFunc() + '</div>'
                            : '') +
                        (me.descBefore ? '<div class="templeEffect">' + me.descBefore + '</div>' : '') +
                        (me.desc1
        ...
        for (let i in M.slot) {
            ...
            str +=
                ...
                i +
                '" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.slotTooltip(' + i + ')', 'this') +
        ...
        for (let i in M.gods) {
            ...
            str +=
                ...
                me.id +
                '" ' +
                Game.getDynamicTooltip('Game.ObjectsById[' + M.parent.id + '].minigame.godTooltip(' + me.id + ')', 'this') +
